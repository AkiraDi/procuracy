                                    ...
                                    <div style="background-color: #EFF3F8;">
                                        <form class="nav-search" id="nav-search" method="post" action="__GROUP__/MyTask/searchlist">
                                            <p style ='margin: '>
                                                ...
                                                <input type="text" id="P_StartTime" name="StartTime" style="width:200px" placeholder="案件起始时间"  onfocus="WdatePicker({dateFmt:'yyyy-M-d H:mm:ss'})" value="<?php echo ($time[StartTime]); ?>">
                                                ------
                                                <input type="text" id="P_EndTime"  name="EndTime" style="width:200px" placeholder="案件结束时间"  onfocus="WdatePicker({dateFmt:'yyyy-M-d H:mm:ss'})" value="<?php echo ($time[EndTime]); ?>"> 
...
<!--                                                    <td>
                                                    ...
                                                    <?php if($vo["status"] == 1): ?><span class="label label-primary" >直播中</span>
                                                    <?php else: ?>
                                                    <span class="label label-success">未直播</span><?php endif; ?>
                                                </td>-->
                                                <td><?php echo ($vo["P_CaseName"]); ?></td>
                                                <td><?php echo ($vo["C_Name"]); ?><?php echo ($vo["CR_Name"]); ?></td>
                                                <td><?php echo ($vo["P_StartTime"]); ?></td>
                                                <td><?php echo ($vo["P_EndTime"]); ?></td>
                                                <td width="20%">
                                                    <button class="btn btn-xs btn-success check" id="<?php echo ($vo["P_ID"]); ?>">
                                                        <i class="ace-icon fa fa-eye bigger-120"></i>
                                                        查看
                                                    </button>
                                                    <button class="btn btn-xs btn-default" id="<?php echo ($vo["P_ID"]); ?>">
