    ...
    <!-- menu level6 End-->
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <input type="text" id="P_StartTime" style="width:200px" placeholder="案件起始时间"  onfocus="WdatePicker({dateFmt: 'yyyy-M-d H:mm:ss'})">
                <input type="text" id="P_EndTime" style="width:200px" placeholder="案件结束时间"  onfocus="WdatePicker({dateFmt: 'yyyy-M-d H:mm:ss'})">
                ...
                <p></p>
                <?php if($admin): ?><form id="form1" method="post" enctype="multipart/form-data" action="__GROUP__/Calendar/importExcel" target="_blank">
