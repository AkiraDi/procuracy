                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div>
                                        <table id="table1" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <?php if(is_array($courtroom)): $i = 0; $__LIST__ = $courtroom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
                                                    <td><?php echo ($vo["CR_Name"]); ?></td>
                                                    <td><?php echo ($vo["C_Name"]); ?></td>
                                                    <td><?php echo ($vo["CR_URL"]); ?></td>
                                                    <td><?php echo ($vo["CR_Port"]); ?></td>
                                                    <td><?php echo ($vo["CR_Comment"]); ?></td>
												<td width="15%">
                                                        <button class="btn btn-xs btn-success" id=<?php echo ($vo["CR_ID"]); ?> >
                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                            编辑
                                                        </button>
                                                        <button class="btn btn-xs btn-danger" id=<?php echo ($vo["CR_ID"]); ?> >
