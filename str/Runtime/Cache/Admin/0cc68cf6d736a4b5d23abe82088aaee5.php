                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        <i class="ace-icon fa fa-table"></i>&nbsp&nbsp直播资源申请（未通过审核案件）
                                    </div>
                                    <!-- <div class="dataTables_borderWrap"> -->
                                    <div>
                                        <table id="table1" class="table table-striped table-bordered table-hover">
                                            <a href="#" class="btn btn-link"><i class="ace-icon fa fa-plus-circle bigger-120 green"></i>新增申请</a>
                                            <thead>
                                                <tr>
                                                    <th>编辑时间</th>
                                                    <th>案件名称</th>
                                            ...
                                            <?php if(is_array($playlist)): $i = 0; $__LIST__ = $playlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
                                                    <td>
                                                        <span class="label label-success"><?php echo ($vo["P_RequestTime"]); ?></span>
                                                    </td>
                                                    ...
                                                    <td width="20%">
                                                        <button class="btn btn-xs btn-success" id=<?php echo ($vo["P_ID"]); ?>>
                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                            编辑
                                                        </button>
                                                        <button class="btn btn-xs btn-danger" id=<?php echo ($vo["P_ID"]); ?>>
            ...
            jQuery(function ($) {
                ...
                $("a[class='btn btn-link']").click(function () {
                    var index = layer.open({
                        type: 2,
                        title: "新增申请",
                        //content: '/index.php/ApplyTask/addTask',
                        content: '/index.php/CaseInput/handAddCase',
                        area: ['900px', '600px'],
                    });
                });
                ...
                $("button[class='btn btn-xs btn-success']").click(function () {
                    ...
                    var index = layer.open({
                        type: 2,
                        title: "编辑申请",
                        //content: '/index.php/ApplyTask/editTask?P_ID='+id,
                        content: '/index.php/CaseInput/editCase?P_ID=' + id,
                        area: ['900px', '600px'],
                    });
                });
                ...
                $("button[class='btn btn-xs btn-danger']").click(function () {
                    ...
                    layer.confirm('是否删除该任务?', {icon: 3, title: '提示'}, function (index) {
                        $.ajax({
                            url: '/index.php/ApplyTask/delTaskHandler?P_ID=' + id,
                            dataType: 'json',
                            type: 'GET',
