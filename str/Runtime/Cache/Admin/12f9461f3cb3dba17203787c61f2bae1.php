						...
						<div class="col-xs-12">
							...
							<div>
								<table id="table1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<?php if(is_array($courts)): $i = 0; $__LIST__ = $courts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
												<td><?php echo ($vo["C_Name"]); ?></td>
												<td><?php echo ($vo["CL_Name"]); ?></td>
												<td><?php echo ($vo["C_ManageBy"]); ?></td>
												<td><?php echo ($vo["C_Man"]); ?></td>
												<td><?php echo ($vo["C_Phone"]); ?></td>
												<td><?php echo ($vo["C_Email"]); ?></td>
												<td><?php echo ($vo["C_Fax"]); ?></td>
												<td><?php echo ($vo["C_Comment"]); ?></td>
												<td width="15%">
													<button class="btn btn-xs btn-success" id=<?php echo ($vo["C_ID"]); ?>>
														<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
														编辑
													</button>
													<button class="btn btn-xs btn-danger" id=<?php echo ($vo["C_ID"]); ?>>
