                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div>
                                        <?php if($admin): ?><form class="nav-search" id="nav-search" method="post" action="__GROUP__/System/findlog">
                                                <p style ='margin: '>
                                                    <input type="hidden" name="isSearch" value="1" />
                                                    <input type="text" id="P_StartTime" name="StartTime" style="width:200px" placeholder="案件起始时间"  onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd H:mm:ss'})" value="<?php echo ($time[StartTime]); ?>">
                                                    ------
                                                    <input type="text" id="P_EndTime"  name="EndTime" style="width:200px" placeholder="案件结束时间"  onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd H:mm:ss'})" value="<?php echo ($time[EndTime]); ?>"> 
                                        ...
                                        <table id="table1" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <?php if(is_array($log)): $i = 0; $__LIST__ = $log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
                                                    <td><?php echo ($vo["L_DateTime"]); ?></td>
                                                    <td><?php echo ($vo["L_P_ID"]); ?></td>
                                                    <td><?php echo ($vo["L_Type"]); ?></td>
